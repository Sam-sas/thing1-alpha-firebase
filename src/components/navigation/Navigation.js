...
export default function Navigation() {
    ...
    const checkUserAuth = (user) => {
        if(user) {
            return (
                <>
                    <div className="logo" id="navLogo">
                        {/* <img src="/img/thing1-logo-square.png"></img> */}
                    </div>
                    <div className="navsandwich-container">
                        <Link to='#' className='menu-bars'>
                            <FaIcons.FaBars stroke="white" onClick={showSidebar} className="navsandwich" />
                        </Link>
                    </div>
                </>
            )
            ...
            return (
                <>
                  <div className='btn-container-logout'>
                        <Button className='nav-logout nav-btn' 
                ...
                <>
                   <div className='account-icon' onClick={showSidebar}>
                    <Link to='/account-page'>
                        <img className="img-thumbnail nav-img" src={url} alt="profile picture of you" />
                    </Link>
                </div>
                </>
            )
